const _tags = [
  ...
  'zod', 'jsdoc', 'jwt', 'converter', 'url', 'polyfill', 'promise', 'cache', 'prototype', 'SEO',
  'storage', 'WebGL', 'proxy', 'typography', 'online', 'offline', 'network', 'authentication', 'select',
  'touch', 'gantt', 'IDE', 'localstorage', 'image', 'cropper', 'Leafer', 'database', 'console',
  'prompt', 'pdf', 'DOM', 'schedule', 'task', 'corn', 'google', 'sheet', 'youtube', 'performance',
  'XML', 'grid', 'text', 'machine-learning', 'deep-larning', 'copy', 'paste', 'detector', 'admin',
  'runner', 'numerical', 'count', 'bot', 'telegram', 'log', 'functional-programming', 'headless',
  'flow', 'onboarding', 'shiki', 'share', 'QRCode', 'apollo', 'no-code', 'drop', 'security', 'router',
  'end-to-end', 'gtag', 'plugin', 'websocket', 'builder', 'mock', 'enum', 'optimization', 'physics',
  'format', '2D'
] as const
...
const data: Row[] = [
  ...
  ['Shikiji 式辞', 'https://github.com/antfu/shikiji', ['syntax', 'highlighter', 'package', 'shiki']],
  ...
  ['Surely Vue Table', 'https://github.com/surely-vue/surely-table', ['component', 'library', 'table', 'Vue']],
  ['Vike', 'https://vike.dev/', ['package', 'Vite', 'SSG', 'SSR', 'framework']],
  ['vite-plugin-node-polyfills', 'https://github.com/davidmyersdev/vite-plugin-node-polyfills', ['Vite', 'NodeJS', 'package', 'polyfill']],
  ['local-pkg', 'https://github.com/antfu/local-pkg', ['package', 'JS']],
  ['Essential JS 2', 'https://ej2.syncfusion.com/home/vue.html', ['component', 'library', 'Vue', 'UI']],
  ['Scalar', 'https://github.com/scalar/scalar', ['API', 'tool', 'documentation']],
  ['apexcharts.js', 'https://github.com/apexcharts/apexcharts.js', ['package', 'visualization', 'chart', 'interactive', 'data', 'chart', 'JS', 'SVG']],
  ['p-timeout', 'https://github.com/sindresorhus/p-timeout', ['package', 'promise']],
  ['Rspack', 'https://www.rspack.dev/zh/', ['bundler', 'build-tool', 'JS']],
  ['Bentocache', 'https://bentocache.julr.dev/docs/introduction', ['NodeJS', 'cache', 'package']],
  ['vue-simple-props', 'https://github.com/sxzz/vue-simple-props', ['Vue', 'package', 'TS']],
  ['OverVue', 'https://github.com/open-source-labs/OverVue', ['Vue', 'prototype', 'tool', 'visualization']],
  ['vue-final-modal', 'https://vue-final-modal.org/', ['Vue', 'modal', 'package']],
  ['NuxtSEO', 'https://nuxtseo.com/', ['SEO', 'Nuxt', 'package']],
  ['ofa.js', 'https://ofajs.com/t-cn/index.html', ['framework', 'JS', 'WebComponent']],
  ['ESLint Stylistic', 'https://eslint.style/', ['ESLint', 'linter', 'formatter']],
  ['kolorist', 'https://github.com/marvinhagemeister/kolorist', ['CLI', 'color', 'NodeJS', 'terminal', 'package']],
  ['localForage', 'https://github.com/localForage/localForage', ['storage', 'JS', 'package']],
  ['@intlify/unplugin-vue-i18n', 'https://github.com/intlify/bundle-tools/tree/main/packages/unplugin-vue-i18n', ['internationalization', 'Vue', 'package']],
  ['Pixijs', 'https://pixijs.com/', ['WebGL', 'canvas', 'JS', 'package']],
  ['Vue Signature Pad', 'https://github.com/neighborhood999/vue-signature-pad', ['Vue', 'component', 'package']],
  ['Anu', 'https://anu-vue.netlify.app/', ['Vue', 'component', 'UI']],
  ['daisyUI', 'https://daisyui.com/', ['UI', 'component', 'TailwindCSS', 'CSS', 'library']],
  ['httpxy', 'https://github.com/unjs/httpxy/tree/main', ['HTTP', 'NodeJS', 'package', 'proxy']],
  ['NuxtUI', 'https://ui.nuxt.com/', ['Nuxt', 'UI', 'component', 'library']],
  ['driver.js', 'https://driverjs.com/', ['JS', 'customizable', 'guide', 'package']],
  ['monaspace', 'https://github.com/githubnext/monaspace', ['font', 'typography', 'code']],
  ['V-Offline', 'https://github.com/vinayakkulkarni/v-offline', ['Vue', 'online', 'offline', 'network', 'component', 'package']],
  ['nuxt-auth-utils', 'https://github.com/Atinux/nuxt-auth-utils', ['Nuxt', 'authentication', 'module', 'package', 'SSR']],
  ['vue-multiselect', 'https://github.com/shentao/vue-multiselect', ['Vue', 'component', 'select', 'JS']],
  ['vue3-touch-events', 'https://github.com/robinrodricks/vue3-touch-events', ['mobile', 'Vue', 'component', 'library', 'touch']],
  ['Flexmonster', 'https://www.flexmonster.com/', ['table', 'chart', 'data', 'visualization', 'component', 'JS']],
  ['Vue-Ganttastic', 'https://zunnzunn.github.io/vue-ganttastic/', ['chart', 'gantt', 'Vue', 'TS', 'component']],
  ['file-icons', 'https://github.com/crabnebula-dev/file-icons', ['VSCode', 'icons', 'package', 'IDE',]],
  ['web-localstorage-plus', 'https://github.com/supanpanCn/web-localstorage-plus', ['localstorage', 'storage', 'package']],
  ['vue-cropper', 'https://github.com/xyxiao001/vue-cropper', ['JS', 'Vue', 'image', 'cropper', 'package']],
  ['fabric.js', 'https://github.com/fabricjs/fabric.js', ['canvas', 'SVG', 'library']],
  ['Leafer UI', 'https://www.leaferjs.com/', ['Leafer', 'canvas', 'UI', 'framework']],
  ['tailwindcss-magic', 'https://github.com/Sylvenas/tailwindcss-magic', ['animation', 'TailwindCSS', 'package']],
  ['vue-concurrency', 'https://vue-concurrency.netlify.app/', ['TS', 'Vue', 'library', 'API']],
  ['Maz-UI', 'https://maz-ui.com/', ['Vue', 'Nuxt', 'tool', 'library', 'component']],
  ['nuxt-edgedb', 'https://github.com/Tahul/nuxt-edgedb', ['Nuxt', 'data', 'database', 'package']],
  ['turbo-console-log', 'https://github.com/Chakroun-Anas/turbo-console-log', ['VSCode', 'extension', 'console', 'JS']],
  ['Biome', 'https://github.com/biomejs/biome', ['linter', 'formatter', 'code', 'JS', 'TS', 'JSON', 'tool']],
  ['bumpp', 'https://github.com/antfu/bumpp', ['version', 'CLI', 'prompt', 'package']],
  ['pdf.js', 'https://github.com/mozilla/pdf.js', ['pdf', 'tool']],
  ['dom-to-image', 'https://github.com/tsayen/dom-to-image', ['JS', 'package', 'SVG', 'DOM', 'HTML', 'image', 'canvas']],
  ['node-schedule', 'https://github.com/node-schedule/node-schedule', ['schedule', 'task', 'corn', 'package']],
  ['google-spreadsheet', 'https://github.com/theoephraim/node-google-spreadsheet', ['google', 'sheet', 'NodeJS', 'JS', 'TS', 'API']],
  ['Pair Diff', 'https://github.com/antfu/vscode-pair-diff', ['VSCode', 'file']],
  ['youtube-background', 'https://github.com/stamat/youtube-background', ['youtube', 'video', 'ESM', 'package']],
  ['Nuxt Web Vitals', 'https://github.com/nuxt-modules/web-vitals', ['module', 'Nuxt', 'google', 'performance']],
  ['Intro.js', 'https://introjs.com/', ['library', 'JS']],
  ['cheerio', 'https://github.com/cheeriojs/cheerio', ['HTML', 'parser', 'XML']],
  ['Vue Grid Layout', 'https://jbaysolutions.github.io/vue-grid-layout/', ['Vue', 'component', 'grid', 'drag', 'package']],
  ['Ark UI', 'https://ark-ui.com/', ['UI', 'component', 'library', 'Vue', 'React', 'toast']],
  ['vivus.js', 'https://github.com/maxwellito/vivus', ['SVG', 'animation', 'JS', 'library', 'package']],
  ['Popmotion', 'https://github.com/popmotion/popmotion', ['animation', 'JS', 'library', 'package']],
  ['Typed.css', 'https://typedcss.com/', ['animation', 'CSS', 'text', 'package']],
  ['typed.js', 'https://github.com/mattboldt/typed.js', ['animation', 'text', 'library', 'package']],
  ['screenshot-to-code', 'https://github.com/abi/screenshot-to-code', ['tool', 'image', 'code', 'AI', 'TailwindCSS', 'Vue', 'React']],
  ['Device Simulator & Tester', 'https://device-simulator.vercel.app/', ['test', 'device', 'extension', 'devtools']],
  ['tensorflow.js', 'https://github.com/tensorflow/tfjs', ['JS', 'machine-learning', 'TS', 'deep-larning', 'NodeJS', 'library']],
  ['jscpd', 'https://github.com/kucherenko/jscpd', ['JS', 'code', 'copy', 'paste', 'detector']],
  ['FormMaking', 'https://form.making.link/', ['form', 'Vue', 'code', 'visualization', 'tool']],
  ['Bag-admin', 'https://vite.itnavs.com/doc/', ['admin', 'console', 'Vue', 'framework']],
  ['Vue DevUI', 'https://vue-devui.github.io/', ['Vue', 'UI', 'component', 'library']],
  ['pkgx', 'https://github.com/pkgxdev/pkgx', ['manager', 'runner', 'CLI', 'tool']],
  ['ncc', 'https://github.com/vercel/ncc', ['compiler', 'TS', 'CLI', 'NodeJS', 'package']],
  ['uni-app', 'https://uniapp.dcloud.net.cn/', ['cross-platform', 'framework', 'Vue', 'JS']],
  ['markdown-it', 'https://github.com/markdown-it/markdown-it', ['markdown', 'parser', 'package', 'JS']],
  ['markdown-it-github-alerts', 'https://github.com/antfu/markdown-it-github-alerts', ['github', 'markdown', 'parser', 'package', 'JS']],
  ['countUp.js', 'https://github.com/inorganik/countUp.js', ['animation', 'numerical', 'count', 'package', 'JS']],
  ['unplugin-raw', 'https://github.com/unplugin/unplugin-raw', ['JS', 'TS', 'package', 'export']],
  ['telegraf.js', 'https://github.com/telegraf/telegraf', ['bot', 'telegram', 'JS', 'TS', 'API', 'package', 'middleware']],
  ['node-telegram-bot-api', 'https://github.com/yagop/node-telegram-bot-api', ['bot', 'telegram', 'JS', 'API', 'package', 'NodeJS']],
  ['boot-vue', 'https://github.com/kirklin/boot-vue', ['Vue', 'TS', 'UnoCSS', 'Pinia', 'type', 'tool']],
  ['eslint-processor-vue-blocks', 'https://github.com/antfu/eslint-processor-vue-blocks', ['ESLint', 'Vue', 'linter', 'package']],
  ['eslint-merge-processors', 'https://github.com/antfu/eslint-merge-processors', ['ESLint','package']],
  ['chalk', 'https://github.com/chalk/chalk', ['terminal', 'package', 'CLI', 'color', 'JS']],
  ['colors.js', 'https://github.com/Marak/colors.js', ['terminal', 'package', 'CLI', 'color', 'JS', 'NodeJS', 'console']],
  ['npmlog', 'https://github.com/npm/npmlog', ['npm', 'log', 'package', 'CLI']],
  ['purify', 'https://github.com/gigobyte/purify', ['functional-programming', 'TS', 'package', 'code']],
  ['nrm', 'https://github.com/Pana/nrm', ['npm', 'manager', 'tool']],
  ['TinyVue','https://opentiny.design/tiny-vue/zh-CN/os-theme/overview', ['Vue', 'component', 'library', 'UI', 'headless']],
  ['arco.design', 'https://arco.design/vue/docs/start', ['Vue', 'component', 'library', 'UI']],
  ['wretch', 'https://github.com/elbywan/wretch', ['http-request', 'API', 'package', 'JS']],
  ['Oxc', 'https://oxc-project.github.io/', ['formatter', 'tool', 'linter', 'parser', 'bundler', 'compiler', 'JS']],
  ['Vue Flow', 'https://vueflow.dev/', ['Vue', 'flow', 'chart', 'component', 'library', 'package', 'TS']],
  ['v-onboarding', 'https://v-onboarding.fatihsolhan.com/', ['Vue', 'onboarding', 'package', 'UI']],
  ['LobeHub UI Kit', 'https://ui.lobehub.com/', ['component', 'library', 'UI']],
  ['vitesse-nuxt3', 'https://github.com/antfu-collective/vitesse-nuxt3', ['template', 'Nuxt', 'Vite', 'TS']],
  ['twoslash', 'https://github.com/twoslashes/twoslash', ['TS', 'syntax', 'shiki', 'package']],
  ['vue-goodshare', 'https://vue-goodshare.js.org/', ['Vue', 'share', 'component', 'package']],
  ['uqr', 'https://github.com/unjs/uqr', ['QRCode', 'ESM', 'package', 'SVG']],
  ['Gridstack.js', 'https://gridstackjs.com/', ['JS', 'Vue', 'React', 'grid', 'component', 'package']],
  ['vue-datepicker', 'https://github.com/Vuepic/vue-datepicker', ['data', 'Vue', 'package', 'component', 'package']],
  ['shadcn/ui', 'https://ui.shadcn.com/', ['UI', 'component', 'library', 'code']],
  ['Vue Apollo', 'https://apollo.vuejs.org/', ['Vue', 'apollo', 'GraphQL', 'library']],
  ['Apollo', 'https://www.apollographql.com/', ['apollo', 'GraphQL', 'API']],
  ['eslint-plugin-unocss', 'https://github.com/devunt/eslint-plugin-unocss', ['ESLint', 'package', 'UnoCSS']],
  ['Vueform', 'https://vueform.com/', ['Vue', 'form', 'package', 'library', 'framework']],
  ['Vueform Builder', 'https://builder.vueform.com/', ['Vue', 'form', 'no-code', 'drag', 'drop', 'build']],
  ['Vueform/toggle', 'https://github.com/vueform/toggle', ['Vue', 'component', 'form', 'package']],
  ['bryntum', 'https://bryntum.com/', ['gantt', 'chart', 'schedule', 'Vue', 'React', 'JS', 'component']],
  ['Vue DevTools', 'https://devtools-next.vuejs.org/', ['Vue', 'devtools', 'package', 'tool']],
  ['Vue Scroll Picker', 'https://vue-scroll-picker.dist.be/', ['Vue', 'package', 'component', 'scroll', 'select']],
  ['unplugin-pure', 'https://github.com/justin-schroeder/unplugin-pure', ['bundler', 'tool', 'Vite', 'esbuild', 'Rollup']],
  ['vite-vue-md', 'https://github.com/privatenumber/vite-vue-md', ['Vue', 'Vite', 'markdown', 'package']],
  ['Vue Data UI', 'https://vue-data-ui.graphieros.com/', ['Vue', 'data', 'UI', 'component', 'chart', 'library', 'visualization']],
  ['NuxtSecurity', 'https://nuxt-security.vercel.app/', ['Nuxt', 'security', 'HTTP']],
  ['core-vapor', 'https://github.com/vuejs/core-vapor', ['Vue', 'DOM']],
  ['DocuSeal', 'https://www.docuseal.co/', ['pdf', 'Vue', 'documentation', 'tool']],
  ['nuxt-typed-router', 'https://github.com/victorgarciaesgi/nuxt-typed-router', ['Nuxt', 'type', 'router', 'package']],
  ['tRPC', 'https://trpc.io/', ['type', 'end-to-end', 'API', 'React']],
  ['fastify', 'https://github.com/fastify/fastify', ['NodeJS', 'framework', 'back-end', 'server']],
  ['Commit Lint Generator', 'https://github.com/leo03164/commit-lint-generator', ['linter', 'commit', 'tool']],
  ['twoslash', 'https://twoslash.netlify.app/', ['TS', 'tool', 'parser']],
  ['request-indexing', 'https://requestindexing.com/', ['google', 'SEO', 'data', 'Nuxt', 'API']],
  ['styled-components', 'https://styled-components.com/', ['package', 'React', 'CSS', 'component']],
  ['@emotion/css', 'https://github.com/emotion-js/emotion/tree/main', ['package', 'React', 'CSS', 'component', 'CSS-in-JS']],
  ['vue-gtag', 'https://github.com/MatteoGabriele/vue-gtag', ['Vue', 'google', 'gtag', 'package', 'plugin']],
  ['crossws', 'https://github.com/unjs/crossws', ['package', 'websocket', 'NodeJS', 'ESM']],
  ['eslint-plugin-fix-later', 'https://github.com/privatenumber/eslint-plugin-fix-later', ['ESLint', 'plugin', 'package', 'code']],
  ['pangu.js', 'https://github.com/vinta/pangu.js', ['package', 'CLI', 'browser', 'code']],
  ['Knex.js', 'https://knexjs.org/', ['builder', 'SQL']],
  ['css-media-splitter', 'https://github.com/levchak0910/css-media-splitter', ['CSS', 'package', 'Nuxt', 'Vite']],
  ['drag-and-drop', 'https://drag-and-drop.formkit.com/', ['drag', 'drop', 'package', 'JS', 'Vue', 'React']],
  ['Tempo', 'https://github.com/formkit/tempo', ['JS', 'TS', 'date', 'time', 'format']],
  ['h3', 'https://h3.unjs.io/', ['framework', 'HTTP', 'server', 'composable', 'back-end']],
  ['alova.JS', 'https://alova.js.org/', ['HTTP', 'hooks', 'Vue', 'React', 'http-request', 'API']],
  ['PageSpy', 'https://github.com/HuolalaTech/page-spy-web', ['debug', 'tool', 'devtools']],
  ['Keen UI', 'https://github.com/JosephusPaye/Keen-UI/tree/master#keen-ui', ['component', 'library', 'UI', 'Vue']],
  ['MSW', 'https://mswjs.io/', ['mock', 'API', 'JS', 'NodeJS', 'library', 'devtools']],
  ['Banana UI', 'https://banana-ui.com/', ['React', 'component', 'library', 'Vue', 'SSR', 'TS', 'UI']],
  ['unplugin-inline-enum', 'https://github.com/unplugin/unplugin-inline-enum', ['package', 'build', 'enum', 'JS', 'TS']],
  ['NuxtImage', 'https://image.nuxt.com/', ['Nuxt', 'image', 'optimization', 'package']],
  ['matter.js', 'https://brm.io/matter-js/', ['engine', 'physics', '2D']],
  ['anime', 'https://animejs.com/', ['engine', 'animation', 'CSS', 'SVG', 'library', 'package']],
  ['babylon.js', 'https://www.babylonjs.com/', ['WebGL', 'TS', 'engine', '3D', 'physics']],
