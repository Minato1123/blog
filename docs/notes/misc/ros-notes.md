...
* Parameter Server
    > 
![](https://i.imgur.com/eHX8VBn.png =700x)
...
![](https://i.imgur.com/gXDo79C.png =400x)
...
![](https://i.imgur.com/25HuvPP.png =450x)
...
![](https://i.imgur.com/9XOTKK1.png =500x)
...
1. **Rate mode**
    ...
    > 在Rate mode下，rostopic 將以特定速率發布訊息。
...
## Build ROS packages
![](https://i.imgur.com/LHV0oLm.png =500x)
